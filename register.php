      ...
      <div class="row">
        ...
        <h4>REGISTER ON CAR2GO</h4>
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" value="Register" style="background: #000000; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
